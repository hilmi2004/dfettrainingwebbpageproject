...
const Journey = () => {
    return (
        <div className="mx-auto py-4 bg-white min-h-screen max-w-screen overflow-hidden w-screen px-4">
            <div className="container mx-auto">
                <h2 className="text-5xl text-black md:text-6xl lg:text-7xl text-center">
                ...
                <div className="mt-6 flex flex-wrap justify-center items-center gap-10 lg:space-x-10">
                    ...
                    <div className="flex justify-center bg-white w-full lg:w-auto">
